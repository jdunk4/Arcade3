...
// Bag is lazily regenerated when exhausted (very rare — 6 chapters × 111 =
// 666 possible saves, and the bag's base size is ~500+).
let _slotBag = null;
...
function _save(h, idx) {
  ...
  // Pick a random free slot from the pre-shuffled bag. Guarantees scatter
  // across all 4 perimeter sides from the very first save — no more
  // "first 4 pigs clump at slots 0-3 on the north side" clustering.
