  ...
  if (waveDef.type === 'powerup' && S.powerupActive) {
    ...
    if (completedId) {
      ...
      if (completedId === 'POWER') {
        ...
        // Stage 3a stub: auto-fire the EMP 2 seconds after RADIO. Stage 3b-2
        // will replace this with the shoot-the-generator mechanic (which
        // needs the missile raised first — openSiloAndRaiseMissile above).
        S._empStubTimer = 2.0;
      }
    }
