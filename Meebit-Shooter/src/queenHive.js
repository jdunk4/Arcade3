 ...
 * frame from the main render loop with the current player position.
 * Mutates playerPos directly so the player is shoved back along the
 * dome surface normal if they try to walk in. No-op once all 4 domes
 * are popped (player needs to be able to walk to the hives in wave 3).
 *
 * Returns true if the player was pushed this frame.
 */
