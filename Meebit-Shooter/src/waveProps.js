...
function _getBodyMat() {
  ...
  const m = new THREE.MeshStandardMaterial({
    // Lightened from 0x2a2a3a (near-black gunmetal) to 0x3e4250 (medium
    // gunmetal). Reads as "polished machinery" rather than "black void"
    // and lets the added gold/copper trim pieces visually pop. Higher
    // metalness makes light catch the surfaces better.
    color: 0x3e4250,
    roughness: 0.45,
    metalness: 0.78,
  });
