...
export const WEAPONS = {
  ...
  grenade: {
    ...
    bullets: 1, spread: 0,
    speed: 11,                 // initial horizontal throw speed (was 18 — too far)
    arc: 7,                    // initial vertical launch speed (was 9 — matched the long throw)
    fuse: 1.6,                 // detonate this long after throw even if airborne
    slot: 'grenade',
    color: 0x88ff55,
    isGrenade: true,
    explosionRadius: 5.5,      // bigger than rocket — it's a grenade
