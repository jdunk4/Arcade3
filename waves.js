...
export function updateWaves(dt) {
  ...
  // the powerup wave is over and the compound is sinking anyway.
  {
    ...
    // Chapter 2 wave 2 reflow — also protect the charging zone + pod
    // landing position. Hazards never spawn on these so the player
    // can always reach the active gameplay zone. Also covers the
    // active/landed pod during the lock-in phase.
    if (S.chapter === 1 && waveDef && waveDef.type === 'datacenter') {
